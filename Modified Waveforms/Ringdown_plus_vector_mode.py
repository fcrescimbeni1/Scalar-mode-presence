...
def TdQNMfromFinalMassSpin_VD(**args):
    ...
    return hp, hc
"""
hp, hc = TdQNMfromFinalMassSpin_VD(approximant="test", final_mass=100, final_spin=0.6, amp220=0.15, amp221=0.42, phi220=2, phi221=0.23, distance=10, inclination=0.26, lmns=["222"], f_lower=20, delta_t=1/(4096*4), toffset=0.002, f_ref=20, t_final=2, harmonics="spheroidal")
"""