...
setup (
    ...
    py_modules = ['Ringdown_plus_vector_mode_generic_overtone'],
    entry_points = {"pycbc.waveform.td":"TdQNMfromFinalMassSpin_VD_pk = Ringdown_plus_vector_mode_pk:TdQNMfromFinalMassSpin_VD_pk"},
    classifiers=[
