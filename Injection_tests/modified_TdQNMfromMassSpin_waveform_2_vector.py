...
a, re_om_v, im_om_v = np.loadtxt("sequence_vector.txt", usecols=(0,1,2), unpack=True)

def TdQNMfromMassSpin_SD_total_v(**args):
    ...
    #scalar mode
    f221_v=f_to_Phys(re_om_v[min_index],final_mass)/(2*np.pi)
    tau221_v=-1/f_to_Phys(im_om_v[min_index],final_mass)
    
    #additional parameters
    delta_f221=f221_v/f221-1
    delta_tau221=tau221_v/tau221-1 
    ...
    return hp, hc
"""
hp, hc = TdQNMfromMassSpin_SD_total_v(approximant="test", final_mass=100, final_spin=0.6, amp220=0.15, amp221=0.42, phi220=2, phi221=0.23, distance=10, inclination=0.26, lmns=["222"], f_lower=20, delta_t=1/(4096*4), toffset=0.002, f_ref=20, t_final=2, harmonics="spheroidal")
"""
